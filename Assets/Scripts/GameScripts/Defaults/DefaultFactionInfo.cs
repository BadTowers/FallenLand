...
public class DefaultFactionInfo {
	...
	public DefaultFactionInfo(){
		...
		/***************************************************/
		curFac = new Faction("Coalition");

	}

			/*
	public static Dictionary<name, Coordinates> FACTION_LOCATIONS = new Dictionary<name, Coordinates>()
	{
		{name.COALITION, new Coordinates(19,13)},
		{name.ENCLAVE, new Coordinates(10,20)},
		{name.SYNDICATE, new Coordinates(4,15)},
		{name.SWAMP_RUNNERS, new Coordinates(20,4)},
		{name.NEW_FEDERALISTS, new Coordinates(25,7)},
		{name.REGULATORS, new Coordinates(14,8)},
		{name.HIGHWAYMEN, new Coordinates(16,16)},
		{name.BROTHERHOOD, new Coordinates(7,11)},
		{name.SONS_OF_NEPTUNE, new Coordinates(23,15)},
		{name.SIGMA, new Coordinates(28,14)},
		{name.NULL, new Coordinates(-1,-1)} //An invalid location
	};


	public static int getFactionNumber(name faction)
	{
		switch (faction) {
		case name.COALITION:
			return 1;
	...
	public static name getFactionName(int num){
		switch (num) {
		case 1:
	...
	public static string getName(name faction)
	{
		switch (faction) {
		case name.COALITION:
