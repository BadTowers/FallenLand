...
namespace FallenLand
{
	public class DefaultCharacterCards
	{
		...
		public DefaultCharacterCards()
		{
			...
			rewardChoice.Add(Gains.Gain_Survival, 1);
			rewardChoice.Add(Gains.Gain_Combat, 2);
			...
			conditionalGain.AddReward(Gains.Gain_Character_Cards_May_Be_Assigned_To_Party, 1);
